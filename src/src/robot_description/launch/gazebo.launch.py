...
@brief Launch file for setting up the robot simulation in Gazebo with custom lighting.

This launch file initializes the robot simulation in Gazebo with a custom world that includes
spotlight illumination, spawns the robot entity, and starts the necessary nodes and controllers 
...
def generate_launch_description():
    ...
    This function sets up the robot description, launches Gazebo with custom world lighting,
    spawns the robot entity, and starts the necessary nodes and controllers.
    ...
    # Path to the custom world file with spotlight illumination
    world_file_name = "custom_world_with_spotlight.sdf"
    ...
    # Node to spawn the entity in Gazebo at position (0,0,0)
    spawn_entity = Node(
        ...
        arguments=[
            ...
            "-y", "0.0", 
            "-z", "0.0",
        ],  # Arguments for spawning at origin (0,0,0)
        output="screen",
    )
